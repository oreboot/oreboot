...
const UART0_BASE: usize = 0xd401_7000;
...
// GPIO 69 = RX, CFG 0x2
// X60 UART0
// GPIO 47 = TX 3V3, CFG 0x1
// GPIO 48 = RX 3V3, CFG 0x1
...
impl Serial for K1XSerial {}

impl embedded_hal_nb::serial::ErrorType for K1XSerial {
    type Error = Error;
}
