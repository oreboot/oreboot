...
impl Serial for TH1520Serial {}

impl embedded_hal_nb::serial::ErrorType for TH1520Serial {
    type Error = Error;
}

impl embedded_hal_nb::serial::Write<u8> for TH1520Serial {
    #[inline]
