...
use crate::dram_helpers::{ddr_phy_reg_rd, ddr_phy_reg_wr, dwc_ddrphy1_phyinit_user_custom_g_wait_fw_done, dwc_ddrphy_phyinit_user_custom_g_wait_fw_done};
...
fn lp4x_3733_phy_train1d2d() {
    ...
    println!("CHA CDD RR01 {}, RR10 {}",0xff&ddr_phy_reg_rd(0x54013),0xff&(ddr_phy_reg_rd(0x54013)>>8));
    println!("CHA CDD RW11 {}, RW10 {}",0xff&ddr_phy_reg_rd(0x54014),0xff&(ddr_phy_reg_rd(0x54014)>>8));
    println!("CHA CDD RW01 {}, RW00 {}",0xff&ddr_phy_reg_rd(0x54015),0xff&(ddr_phy_reg_rd(0x54015)>>8));
    println!("CHA CDD WR11 {}, WR10 {}",0xff&ddr_phy_reg_rd(0x54016),0xff&(ddr_phy_reg_rd(0x54016)>>8));
    println!("CHA CDD WR01 {}, WR00 {}",0xff&ddr_phy_reg_rd(0x54017),0xff&(ddr_phy_reg_rd(0x54017)>>8));
    println!("CHA CDD WW01 {}, WW10 {}",0xff&ddr_phy_reg_rd(0x54018),0xff&(ddr_phy_reg_rd(0x54018)>>8));
    println!("CHB CDD RR01 {}, RR10 {}",0xff&ddr_phy_reg_rd(0x5402d),0xff&(ddr_phy_reg_rd(0x5402c)>>8));
    println!("CHB CDD RW11 {}, RW10 {}",0xff&ddr_phy_reg_rd(0x5402e),0xff&(ddr_phy_reg_rd(0x5402d)>>8));
    println!("CHB CDD RW01 {}, RW00 {}",0xff&ddr_phy_reg_rd(0x5402f),0xff&(ddr_phy_reg_rd(0x5402e)>>8));
    println!("CHB CDD WR11 {}, WR10 {}",0xff&ddr_phy_reg_rd(0x54030),0xff&(ddr_phy_reg_rd(0x5402f)>>8));
    println!("CHB CDD WR01 {}, WR00 {}",0xff&ddr_phy_reg_rd(0x54031),0xff&(ddr_phy_reg_rd(0x54030)>>8));
    println!("CHB CDD WW01 {}, WW10 {}",0xff&ddr_phy_reg_rd(0x54032),0xff&(ddr_phy_reg_rd(0x54031)>>8));
    ...
    println!("TrainedVREFDQ_RANK0  : {}",0xff&(ddr_phy_reg_rd(0x54026)>>8));
    println!("TrainedVREFDQ_RANK1  : {}",0xff&(ddr_phy_reg_rd(0x54027)));
    println!("RxClkDly_Margin_A0   : {}",0xff&(ddr_phy_reg_rd(0x54027)>>8));
    println!("VrefDac_Margin_A0    : {}",0xff&(ddr_phy_reg_rd(0x54028)));
    println!("TxDqDly_Margin_A0    : {}",0xff&(ddr_phy_reg_rd(0x54028)>>8));
    println!("DeviceVref_Margin_A0 : {}",0xff&(ddr_phy_reg_rd(0x54029)));
    println!("RxClkDly_Margin_A1   : {}",0xff&(ddr_phy_reg_rd(0x54029)>>8));
    println!("VrefDac_Margin_A1    : {}",0xff&(ddr_phy_reg_rd(0x5402a)));
    println!("TxDqDly_Margin_A1    : {}",0xff&(ddr_phy_reg_rd(0x5402a)>>8));
    println!("DeviceVref_Margin_A1 : {}",0xff&(ddr_phy_reg_rd(0x5402b)));
    println!("TrainedVREFDQ_RANK0  : {}",0xff&(ddr_phy_reg_rd(0x54040)));
    println!("TrainedVREFDQ_RANK1  : {}",0xff&(ddr_phy_reg_rd(0x54040)>>8));
    println!("RxClkDly_Margin_A0   : {}",0xff&(ddr_phy_reg_rd(0x54041)));
    println!("VrefDac_Margin_A0    : {}",0xff&(ddr_phy_reg_rd(0x54041)>>8));
    println!("TxDqDly_Margin_A0    : {}",0xff&(ddr_phy_reg_rd(0x54042)));
    println!("DeviceVref_Margin_A0 : {}",0xff&(ddr_phy_reg_rd(0x54042)>>8));
    println!("RxClkDly_Margin_A1   : {}",0xff&(ddr_phy_reg_rd(0x54043)));
    println!("VrefDac_Margin_A1    : {}",0xff&(ddr_phy_reg_rd(0x54043)>>8));
    println!("TxDqDly_Margin_A1    : {}",0xff&(ddr_phy_reg_rd(0x54044)));
    println!("DeviceVref_Margin_A1 : {}",0xff&(ddr_phy_reg_rd(0x54044)>>8));
}