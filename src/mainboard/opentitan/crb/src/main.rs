...
pub extern "C" fn _start_boot_hart(_hart_id: usize, fdt_address: usize) -> ! {
    ...
    m.pwrite(&[0xc2u8, 0x40u8, 0x14u8, 0x06u8, ], 0x40070004);
    m.pwrite(&[0x07u8, 0x92u8, 0x28u8, 0x0bu8, ], 0x40070008);
    m.pwrite(&[0x4cu8, 0xe3u8, 0x3cu8, 0x10u8, ], 0x4007000c);
    m.pwrite(&[0x91u8, 0x34u8, 0x51u8, 0x15u8, ], 0x40070010);
    m.pwrite(&[0xd6u8, 0x85u8, 0x65u8, 0x1au8, ], 0x40070014);
    m.pwrite(&[0x1bu8, 0xd7u8, 0x79u8, 0x1fu8, ], 0x40070018);
    m.pwrite(&[0x60u8, 0x08u8, 0x00u8, 0x00u8, ], 0x4007001c);
    m.pwrite(&[0xc2u8, 0x40u8, 0x14u8, 0x06u8, ], 0x40070020);
    m.pwrite(&[0x07u8, 0x92u8, 0x28u8, 0x0bu8, ], 0x40070024);
    m.pwrite(&[0x4cu8, 0xe3u8, 0x3cu8, 0x10u8, ], 0x40070028);
    m.pwrite(&[0x91u8, 0x34u8, 0x51u8, 0x15u8, ], 0x4007002c);
    m.pwrite(&[0xd6u8, 0x85u8, 0x65u8, 0x1au8, ], 0x40070030);
    m.pwrite(&[0x1bu8, 0xd7u8, 0x79u8, 0x1fu8, ], 0x40070034);
    m.pwrite(&[0x60u8, 0x08u8, 0x00u8, 0x00u8, ], 0x40070038);
